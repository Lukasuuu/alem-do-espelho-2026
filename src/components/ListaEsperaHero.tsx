    ...
    >
      ...
      <div className="relative mx-auto grid max-w-6xl items-center gap-14 px-5 sm:px-8 lg:grid-cols-[1.05fr_0.95fr] lg:gap-16">
        ...
        <div className="order-2 lg:order-1">
          ...
          >
            Há um momento em que deixas de procurar respostas lá fora e percebes que tudo
            começa dentro de ti. O Além do Espelho não é apenas um evento. É um encontro
            contigo.
          </motion.p>
